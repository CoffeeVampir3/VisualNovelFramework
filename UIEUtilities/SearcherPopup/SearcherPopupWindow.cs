...
namespace VisualNovelFramework.Elements.Utils
{
    ...
    {
        private static int currentPicker = 0;
        private static Action<Object> returnFunction;
        ...
        {
            MethodInfo m = typeof(EditorGUIUtility).GetMethod(nameof(EditorGUIUtility.ShowObjectPicker), BindingFlags.Public | BindingFlags.Static);
