...
namespace VisualNovelFramework.Editor.Outfitter
{
    ...
    {
        private static readonly float DefaultReferenceScale = 1f;
        private static readonly float DefaultMinScale = 0.05f;
        private static readonly float DefaultMaxScale = 2.5f;
        private static readonly float DefaultScaleStep = 0.1f;

        /// <summary>
        ///     Scale that should be computed when scroll wheel offset is at zero.
        /// </summary>
        private float referenceScale { get; set; } = DefaultReferenceScale;

        private float minScale { get; set; } = DefaultMinScale;
        private float maxScale { get; set; } = DefaultMaxScale;
